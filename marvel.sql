...
-- The cinema has just heard that they will be holding an exclusive midnight showing 
...
-- Find out the show time of "Iron Man 2" and set the show time of "Iron Man 3" to 
...
DELETE FROM people WHERE name IN('Montgomery Burns', 'Mayor Joe Quimby', 'Groundskeeper Willie');
SELECT * FROM people;